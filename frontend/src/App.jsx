...
// Header Component
// Enhanced Header Component with Project Selector
// Simple Header Component with Project Selector
...
const PriorityTaskManager = () => {
  ...
  // Settings handlers - 🔧 FIXED VERSIONS
  ...
  const handleExportData = () => {
    ...
    try {
      const message = exportAllData(); // Use the context function
      showToast(message);
    } catch (error) {
  ...
  const handleImportData = (file) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        const message = importAllData(importData); // Use the context function
        showToast(message);
      } catch (error) {
  ...
  // 🔧 DEBUG: Log what we're passing to SettingsModal
  console.log('🔍 SettingsModal props check:', {
  isOpen: showSettings,
  priorityCategories: priorityCategories?.length,
  taskStats,
  onUpdateCategories: typeof handleUpdateCategories,
  onExportData: typeof handleExportData,
  onImportData: typeof handleImportData,
  onResetData: typeof handleResetData
});
  ...
  return (
    <div className="app">
      ...
      {/* 🔧 FIXED: SettingsModal with proper props */}
      {showSettings && (
  <SettingsModal
    isOpen={showSettings}
    onClose={() => {
